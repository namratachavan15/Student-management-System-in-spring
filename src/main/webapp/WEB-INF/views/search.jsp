    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-warning">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/addStd">Add Student</a></li>
                <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/search">Search Student</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <script>
        function submitForm() {
            ...
            if (name) {
              ...
              var url = "${pageContext.request.contextPath}/search/" + encodeURIComponent(name);
